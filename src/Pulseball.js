...
pulseball.prototype.sortRankingsTable = function() {
...
pulseball.prototype.findRankingsTablePosition = function(array, attr1,attr2, value) {
...
pulseball.prototype.addMatch = function( match ) {
  ...
  this.updateRankings(pointsDifference, homeIndex, awayIndex, outcome)
  this.sortRankingsTable();
};

pulseball.prototype.updateRankings = function(pointsDifference, homeIndex, awayIndex, outcome) {
  if (outcome == "B") {
